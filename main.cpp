...
unsigned long long v[10000000], b[10000000], fr[100000000],w[10000000],nrmaxi;
unsigned long long bb[100000001], maxi,bux,aux,piv;
int i, n, j, ok, nrtest, nrcif, ok1, ok2, ok3, ok4, ok5;

void BubbleSort()
{
    for(i=0; i<n-1; i++) // numarul pasi = lungime - 1, deci avem n-1 pasi intotdeauna
        // de ex daca avem un array de lungime 10, vor fi 9 pasi
        // de lungime 15 vor fi 14 pasi
        // etc.
    {
        t_stop10 = clock();
...
int partitie2(int p, int u)
{
    ...
    if(seconds10 > 10 && ok3 == 0)
    {
        cout << "Ignorat QuickSort cu pivot mediana din 3 elemente\n";
        ok3 = 1;
    }
    int i,j;
    ///--------------------------
    ...
    while(1<2)
    {
        ...
        p++; // avansez spre dreapta
        u--; // avansez spre stanga
    }
}
...
void quickSort1(int p, int u)
{
    t_stop10 = clock();
    seconds10 = (double)(t_stop10-t_start)/CLOCKS_PER_SEC;
    if(seconds10 > 10 && ok2 == 0)
    {
        cout << "Ignorat QuickSort cu pivot ultimul element\n";
        ok2 = 1;
    }
    else if (p < u)
    {
        ...
        quickSort1(poz + 1,u); // apelez pentru jumatatea din dreapta
    }
}
...
///-------------------------------------------------------
        ...
        {
            cout << "Nu se poate efectua sortarea CountingSort" << endl;
        }
...
///-----------------------------------------------------
        ...
        cout<<"\nNumarul de elemente este "<<n<<"."<<endl;
        cout<<"\nMaximul din array poate fi "<<nrmaxi<<"."<<endl;
        if(tip==1)
            cout<<"Tipul de test este pentru un vector aproape sortat crescator.\n";
        if(tip==2)
            cout<<"Tipul de test este pentru un vector aproape sortat descrescator.\n";
        if(tip==3)
            cout<<"Tipul de test este pentru un vector constant.\n";
        if(tip==4)
            cout<<"Tipul de test este pentru un vector generat random.\n";
        cout<<"Au fost alese "<<nrbaze<<" baze pentru RadixSort."<<endl;
        ...
        if(ok5 == 0)
            ...
            cout<<"\nNu se poate efectua sortarea BubbleSort.\n";


        // COUNTING SORT AFISARE
        if(ok1 == 0)
            cout<<"\nTimpul de executie al programului pentru metoda Counting Sort este " <<setprecision(20)<<seconds2<< "s\n";
        else
            cout<<"\nNu se poate efectua sortarea CountingSort.\n";
        ...
        if(ok4 == 0)
            ...
            cout<<"\nNu se poate efectua sortarea MergeSort.\n";

        // RADIX SORT BAZE AFISARE
        index_baze=1;
        while(index_baze<=nrbaze)
        {
            cout<<"\nTimpul de executie al programului pentru metoda Radix Sort baza "<<baza[index_baze]<<" este "<<setprecision(8)<< seconds4[index_baze]<< "s\n";
        ...
        // QUICK SORT ULTIMUL ELEMENT PIVOT AFISARE
        if(ok2 == 0)
            cout<<"\nTimpul de executie al programului pentru metoda Quick Sort stabilind ca pivot ultimul element este " <<setprecision(20)<<seconds5<< "s\n";
        else
            cout<<"\nNu se poate efectua sortarea QuickSort cu pivot ultimul element.\n";


        // QUICK SORT PIVOT MEDIANA DIN 3 AFISARE
        if(ok3 == 0)
            cout<<"\nTimpul de executie al programului pentru metoda Quick Sort stabilind ca pivot mediana din 3 este " << setprecision(20)<<seconds6<< "s\n";
        else
            cout<<"\nNu se poate efectua sortarea QuickSort cu pivot mediana din 3.\n";


        // RADIX SORT PE BITI AFISARE
        cout<<"\nTimpul de executie al programului pentru metoda Radix Sort pe biti este " <<setprecision(20)<< seconds7<< "s\n";


        // FUNCTIA NATIVA C++ AFISARE
        cout<<"\nTimpul de executie al programului pentru functia nativa sort " << setprecision(20)<<seconds8<< "s\n";
    }
    getchar();
    return 0;
